...
# extract columns
./scripts/subset_data.py --dropna COG_DECLINE --decline --age --sex --no-diag --cases --no-controls --aparc --no-aseg $DPATH_FL_DATA_LATEST {adni,ppmi,qpn}
...
./scripts/subset_data.py --dropna AGE --no-decline --age --sex --no-diag --no-cases --controls --no-aparc --aseg $DPATH_FL_DATA_LATEST {adni,ppmi,qpn}
...
./scripts/split_train_test.py --n-splits 10 --stratify-col COG_DECLINE --shuffle --no-standardize --random-state $RANDOM_SEED --tag-adaptation decline-age-sex-diag-hc-aparc-aseg --no-norm $DPATH_FL_DATA_LATEST $DPATH_NORMATIVE_MODELLING_DATA {adni,ppmi,qpn}-decline-age-sex-case-aparc
./scripts/split_train_test.py --n-splits 10 --stratify-col AGE --shuffle --no-standardize --random-state $RANDOM_SEED --tag-adaptation decline-age-sex-diag-hc-aparc-aseg --no-norm $DPATH_FL_DATA_LATEST $DPATH_NORMATIVE_MODELLING_DATA {adni,ppmi,qpn}-age-sex-hc-aseg
./scripts/split_train_test.py --n-splits 10 --stratify-col AGE --min-age 55 --shuffle --no-standardize --random-state $RANDOM_SEED --tag-adaptation decline-age-sex-diag-hc-aparc-aseg --no-norm $DPATH_FL_DATA_LATEST $DPATH_NORMATIVE_MODELLING_DATA {adni,ppmi,qpn}-age-sex-hc-aseg
...
# no normative model (also no z-scoring)
parallel ./scripts/get_data-mega.py --tag decline-age-sex-case-aparc --suffix '-{}train' --random-state $RANDOM_SEED $DPATH_FL_DATA_LATEST adni ppmi qpn ::: {0..9}
parallel ./scripts/get_data-mega.py --tag age-sex-hc-aseg --suffix '-{}train' --random-state $RANDOM_SEED $DPATH_FL_DATA_LATEST adni ppmi qpn ::: {0..9}
